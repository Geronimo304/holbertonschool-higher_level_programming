...
class Rectangle:
    ...
    def __str__(self):
        """Representación del rectángulo usando el símbolo print_symbol."""
        if self.width == 0 or self.height == 0:
            return ""
    ...
    def __repr__(self):
        """Representación que permite recrear una instancia con eval()."""
        return f"Rectangle({self.width}, {self.height})"

    def __del__(self):
        """Acciones al borrar una instancia: mensaje y decremento contador."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1

    @staticmethod
    def bigger_or_equal(rect_1, rect_2):
        """Devuelve el rectángulo con el área mayor o rect_1 si son iguales.
